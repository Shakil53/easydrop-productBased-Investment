...
import { tableProducts } from "@/api/totalProducts";

const TotalProducts = () => {
    const [currentPage, setCurrentPage] = useState(1);
    const rowsPerPage = 15;
    const totalPages = Math.ceil(tableProducts.length / rowsPerPage);

    // Get current page data
    const currentData = tableProducts.slice(
    ...
    return (
        ...
        <div className="p-4 flex justify-between">
            <h1 className="font-semibold text-xl sm:text-3xl">Total Products</h1>
                ...
                <Table>
                    <TableHeader>
                        <TableRow>
                            ...
                            <TableHead className="text-lg">Current Quantity</TableHead>
                    ...
                    <TableBody>
                        {currentData.map((data, index) => (
                            <TableRow key={data.invoice}>
                                ...
                                <TableCell className='px-20'>{data.quantity}</TableCell>
